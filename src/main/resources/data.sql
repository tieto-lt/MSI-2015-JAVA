insert into user(email, first_name, last_name, password, date_created, role, points_to_give) values ('user1@oho.lt', 'Agnė', 'Jegova', 'password1', '2015.05.05', '1', 1000);	
insert into user(email, first_name, last_name, password, date_created, role, points_to_give) values ('user2@oho.lt', 'Marius', 'Alchimavicius', 'password2', '2015.02.06', '0', 1000);	
insert into user(email, first_name, last_name, password, date_created, role, points_to_give) values ('user3@oho.lt', 'Var', 'Gar', 'password3', '2013.06.13', '0', 1000);	
